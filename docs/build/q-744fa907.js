...
\`\`\``,editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik/src/core/use/use-context.ts",mdFile:"qwik.createcontextid.md"},{name:"CSSProperties",id:"cssproperties",hierarchy:[{name:"CSSProperties",id:"cssproperties"}],kind:"Interface",content:"```typescript\nexport interface CSSProperties extends CSS.Properties<string | number>, CSS.PropertiesHyphen<string | number> \n```\n**Extends:** CSS.Properties&lt;string \\| number&gt;, CSS.PropertiesHyphen&lt;string \\| number&gt;",editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik/src/core/render/jsx/types/jsx-generated.ts",mdFile:"qwik.cssproperties.md"},{name:"DOMAttributes",id:"domattributes",hierarchy:[{name:"DOMAttributes",id:"domattributes"}],kind:"Interface",content:`\`\`\`typescript
...
|  [target](#) |  | EventTarget &amp; T |  |`,editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik/src/core/render/jsx/types/jsx-qwik-events.ts",mdFile:"qwik.qwikfocusevent.md"},{name:"QwikIntrinsicElements",id:"qwikintrinsicelements",hierarchy:[{name:"QwikIntrinsicElements",id:"qwikintrinsicelements"}],kind:"Interface",content:`The interface holds available attributes of both native DOM elements and custom Qwik elements. An example showing how to define a customizable wrapper component:
...
|  [scroll?](#) |  | boolean | _(Optional)_ |`,editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik-city/runtime/src/link-component.tsx",mdFile:"qwik-city.linkprops.md"},{name:"Loader",id:"loader",hierarchy:[{name:"Loader",id:"loader"}],kind:"Interface",content:"```typescript\nexport interface Loader<RETURN> \n```",editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik-city/runtime/src/types.ts",mdFile:"qwik-city.loader.md"},{name:"LoaderSignal",id:"loadersignal",hierarchy:[{name:"LoaderSignal",id:"loadersignal"}],kind:"TypeAlias",content:"```typescript\nexport type LoaderSignal<T> = T extends () => ValueOrPromise<infer B> ? ReadonlySignal<ValueOrPromise<B>> : ReadonlySignal<T>;\n```",editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik-city/runtime/src/types.ts",mdFile:"qwik-city.loadersignal.md"},{name:"MenuData",id:"menudata",hierarchy:[{name:"MenuData",id:"menudata"}],kind:"TypeAlias",content:"```typescript\nexport type MenuData = [pathname: string, menuLoader: MenuModuleLoader];\n```",editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik-city/runtime/src/types.ts",mdFile:"qwik-city.menudata.md"},{name:"NavigationType",id:"navigationtype",hierarchy:[{name:"NavigationType",id:"navigationtype"}],kind:"TypeAlias",content:"```typescript\nexport type NavigationType = 'initial' | 'form' | 'link' | 'popstate';\n```",editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik-city/runtime/src/types.ts",mdFile:"qwik-city.navigationtype.md"},{name:"PageModule",id:"pagemodule",hierarchy:[{name:"PageModule",id:"pagemodule"}],kind:"Interface",content:`\`\`\`typescript
...
|  [ip?](#) |  | string | _(Optional)_ |`,editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik-city/middleware/request-handler/types.ts",mdFile:"qwik-city.clientconn.md"},{name:"Cookie",id:"cookie",hierarchy:[{name:"Cookie",id:"cookie"}],kind:"Interface",content:`\`\`\`typescript
...
void`,mdFile:"qwik-city.cookie.set.md"}],R={id:T,package:"@builder.io/qwik-city/middleware/request-handler",members:S},I="qwik-city-middleware-vercel-edge",P=[{name:"createQwikCity",id:"createqwikcity",hierarchy:[{name:"createQwikCity",id:"createqwikcity"}],kind:"Function",content:`\`\`\`typescript
...
|  [staticPaths?](#) |  | string\\[\\] | _(Optional)_ Manually add pathnames that should be treated as static paths and not SSR. For example, when these pathnames are requested, their response should come from a static file, rather than a server-side rendered response. |`,editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik-city/adapters/cloudflare-pages/vite/index.ts",mdFile:"qwik-city.cloudflarepagesadapteroptions.md"}],V={id:z,package:"@builder.io/qwik-city/vite/cloudflare-pages",members:j},N="qwik-city-vite-node-server",L=[],$={id:N,package:"@builder.io/qwik-city/vite/node-server",members:L},H="qwik-city-vite-netlify-edge",J=[{name:"netlifyEdgeAdapter",id:"netlifyedgeadapter",hierarchy:[{name:"netlifyEdgeAdapter",id:"netlifyedgeadapter"}],kind:"Function",content:`\`\`\`typescript
...
|  [getRootDir](#) |  | () =&gt; string \\| null |  |`,editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik/src/optimizer/src/plugins/vite.ts",mdFile:"qwik.qwikvitepluginapi.md"},{name:"QwikVitePluginOptions",id:"qwikvitepluginoptions",hierarchy:[{name:"QwikVitePluginOptions",id:"qwikvitepluginoptions"}],kind:"TypeAlias",content:"```typescript\nexport type QwikVitePluginOptions = QwikVitePluginCSROptions | QwikVitePluginSSROptions;\n```",editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik/src/optimizer/src/plugins/vite.ts",mdFile:"qwik.qwikvitepluginoptions.md"},{name:"relative",id:"path-relative",hierarchy:[{name:"Path",id:"path-relative"},{name:"relative",id:"path-relative"}],kind:"MethodSignature",content:`\`\`\`typescript
...
\`\`\``,editUrl:"https://github.com/BuilderIO/qwik/tree/main/packages/qwik/src/testing/library.ts",mdFile:"qwik.createdom.md"}],ce={id:se,package:"@builder.io/qwik/testing",members:de},t=new Set,pe={qwik:c,"qwik-city":m,"qwik-city-middleware-azure-swa":y,"qwik-city-middleware-cloudflare-pages":w,"qwik-city-middleware-netlify-edge":b,"qwik-city-middleware-node":x,"qwik-city-middleware-request-handler":R,"qwik-city-middleware-vercel-edge":_,"qwik-city-static":E,"qwik-city-vite-azure-swa":U,"qwik-city-vite-cloud-run":Q,"qwik-city-vite-cloudflare-pages":V,"qwik-city-vite-node-server":$,"qwik-city-vite-netlify-edge":X,"qwik-city-vite-static":K,"qwik-city-vite-vercel":ee,"qwik-optimizer":ie,"qwik-server":ae,"qwik-testing":ce},le=()=>(t.size||pe.qwik.members.forEach(e=>t.add(a(e.kind))),t),he=()=>Array.from(le()).reduce((e,o)=>(typeof o!="string"||(e[o]=!0),e),{})||{},ye=n(i(()=>r(()=>import("./q-71541500.js"),["build/q-71541500.js","build/q-3396b8e1.js","build/q-2ab75100.js"]),"s_hIgzPrlKRhw")),ke=n(i(()=>r(()=>import("./q-d2c98f7f.js"),["build/q-d2c98f7f.js","build/q-3396b8e1.js","build/q-2ab75100.js"]),"s_O6uLU0g1RNA")),ge=n(i(()=>r(()=>import("./q-81c6f402.js"),["build/q-81c6f402.js","build/q-3396b8e1.js","build/q-2ab75100.js"]),"s_Kx1MJMeM3Oc"));export{ge as ApiMemberList,ke as ApiMemberWrapper,pe as _auto_apiData,he as _auto_getInitialFilterState,le as _auto_getUniqueKinds,ye as default};
