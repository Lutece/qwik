import{h as i,F as r,H as n,x as l}from"./q-3396b8e1.js";const d=[{text:"Understanding the Runtime",id:"understanding-the-runtime",level:2}],s={title:"Event Listeners | Tutorial",meta:[],styles:[],links:[],frontmatter:{contributors:["manucorporat","adamdbradley","the-r3aper7","mhevery"]}},h={title:"Event Listeners | Tutorial",contributors:["manucorporat","adamdbradley","the-r3aper7","mhevery"]};function o(t){const e=Object.assign({p:"p",code:"code",h2:"h2",a:"a",span:"span",blockquote:"blockquote",strong:"strong",div:"div",pre:"pre",ol:"ol",li:"li",ul:"ul"},t.components);return n(l,{children:[n(e.p,{children:"A key feature of any framework is making it easy to listen to user events."}),`
...
`]})]})}function a(t={}){const{wrapper:e}=t.components||{};return e?n(e,Object.assign({},t,{children:n(o,t)})):o(t)}const p=()=>i(r,{children:i(a,{},3,null)},3,"0SGP8EUG");export{p as default,h as frontmatter,s as head,d as headings};
