...
`,i(e.li,{children:["Application state - restore any data that was fetched or saved in a ",i(e.code,{children:"store"})," on the server."]}),`
`]}),`
...
`,i(e.p,{children:["All other frameworks' hydration ",i(e.strong,{children:"replays"})," all the application logic on the client. Qwik instead pauses execution on the server, and resumes execution on the client."]}),`
...
`,i(e.p,{children:"Resumability is about pausing execution on the server and resuming execution on the client without having to replay and download all of the application logic."}),`
...
`,i(e.ol,{children:[`
`,i(e.li,{children:[i(e.a,{href:"https://qwik.builder.io/docs/advanced/qwikloader/",children:"Qwikloader"})," sets up a single global listener instead of many individual listeners per DOM element. This step can be done with no application code present."]}),`
`,i(e.li,{children:"The HTML contains a URL to the chunk and symbol name. The attribute tells Qwikloader which code chunk to download and which symbol to retrieve from the chunk and then to be executed."}),`
`,i(e.li,{children:"Finally, to make all of the above possible, Qwik's event processing implementation understands asynchronicity which allows it to lazy load closures automatically."}),`
`]}),`
...
`,i(e.p,{children:["Qwik collects ",i(e.a,{href:"https://qwik.builder.io/docs/cheat/serialization/",children:"component boundary information"})," as part of the SSR/SSG and then serializes that information into HTML. The result is that Qwik can:"]}),`
`,i(e.ol,{children:[`
...
`]}),`
`,i(e.p,{children:["For cases where serialization is not possible, code should run ",i(e.a,{href:"https://qwik.builder.io/docs/components/lifecycle/#serverbrowser-only-task",children:"on client only"}),"."]}),`
...
`]})]})}function s(t={}){const{wrapper:e}=t.components||{};return e?i(e,Object.assign({},t,{children:i(a,t)})):a(t)}const p=()=>n(o,{children:n(s,{},3,null)},3,"bv3aRV7C");export{p as default,d as frontmatter,h as head,c as headings};
